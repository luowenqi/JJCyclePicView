 ...
 *   downloading. This block is thus called repeatedly with a partial image. When image is AGy downloaded, the
 *   block is called a last time with the AG image and the last parameter set to YES.
 *
